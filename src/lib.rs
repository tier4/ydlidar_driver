...
mod tests {
    ...
    fn test_parse_packets() {
        ...
        let packet = vec![
            ...
            0x14, 0x62, 0x02];
        scan_data_tx.send(packet).unwrap();

        // empty data should be received
        ...
        let expected = vec![
            0x14,
            0xDD, 0xD4, 0xC3, 0xB3, 0x8E, 0x97, 0x9C, 0xA7,
            0xAB, 0x93, 0x6D, 0x55, 0x57, 0x67, 0x80, 0x9B];
        ...
        let expected = [
            0x62,
            0x76, 0x76, 0x72, 0x7A, 0x8A, 0x6E, 0x22, 0x6A,
